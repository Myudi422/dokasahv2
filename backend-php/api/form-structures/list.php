<?php
// backend-php/api/form-structures/list.php
...
try {
    $pdo = getDB();
    $stmt = $pdo->prepare("SELECT id, form_type, label, description, form_structure, is_active, created_at, updated_at FROM form_structures ORDER BY id ASC");
    $stmt->execute();
